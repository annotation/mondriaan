...
@description=the morphological tag of the token
@valueType=str
@version=0.8.15
...
Clitic=Yes|Number=Sing|Person=2|PronType=Prs
Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin
...
Mood=Ind|Number=Sing|Person=3|Tense=Past|VerbForm=Fin
Number=Plur|Tense=Pres|VerbForm=Part
...
Clitic=Yes|Number=Sing|Person=1|PronType=Prs
...
Clitic=Yes|Gender=Masc|Number=Sing|Person=3|PronType=Prs|VerbForm=Ger
Clitic=Yes|Number=Sing|Person=1|PronType=Prs
...
Mood=Sub|Number=Sing|Person=3|VerbForm=Fin
NumType=Card
...
Gender=Fem|Number=Plur|Tense=Past|VerbForm=Part
...
Mood=Cnd|Number=Plur|Person=3|Tense=Pres|VerbForm=Fin
...
Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin
Clitic=Yes|Number=Plur|Person=2|PronType=Prs
...
Clitic=Yes|Gender=Fem|Number=Sing|Person=3|PronType=Prs|VerbForm=Ger
...
Mood=Imp|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin
Gender=Masc|Number=Sing
...
Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin
Gender=Fem|Number=Plur
Clitic=Yes|Gender=Fem|Number=Sing|Person=3|PronType=Prs|VerbForm=Inf
...
Clitic=Yes|Gender=Masc|Number=Plur|Person=3|PronType=Prs|VerbForm=Inf
...
Clitic=Yes|Number=Plur|Person=1|PronType=Prs
VerbForm=Inf
Foreign=Yes
...
Gender=Fem|Number=Sing
Mood=Cnd|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin
...
Clitic=Yes|PronType=Prs|VerbForm=Ger
NumType=Card
...
Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin
Gender=Masc
Number=Plur|Person=1|PronType=Prs
Foreign=Yes
...
Clitic=Yes|Number=Sing|Person=2|PronType=Prs|VerbForm=Ger
Gender=Masc
...
Clitic=Yes|Person=3|PronType=Prs|VerbForm=Inf
...
Definite=Def|Gender=Masc|Number=Plur|PronType=Art
Clitic=Yes|Gender=Masc|Number=Sing|Person=3|PronType=Prs|VerbForm=Inf
...
Clitic=Yes|PronType=Prs|VerbForm=Inf
...
Gender=Masc
Mood=Cnd|Number=Sing|Person=2|Tense=Pres|VerbForm=Fin
...
Gender=Masc|Number=Sing
Gender=Masc|Number=Plur|Person=3|PronType=Prs
Gender=Masc|Number=Plur
NumType=Card
Gender=Masc|Number=Sing
...
Clitic=Yes|Gender=Fem|Person=3|PronType=Prs|VerbForm=Ger
...
Number=Sing|Tense=Pres|VerbForm=Part
Gender=Masc
NumType=Card
...
Gender=Masc
Mood=Cnd|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin
VerbForm=Inf
